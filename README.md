...
Tracked at [github.com/davidorex/cc-history-api/issues](https://github.com/davidorex/cc-history-api/issues).

Filter by label:

- [`bug`](https://github.com/davidorex/cc-history-api/issues?q=is%3Aissue+label%3Abug) — Something isn't working
- [`feature`](https://github.com/davidorex/cc-history-api/issues?q=is%3Aissue+label%3Afeature) — New functionality
- [`gap`](https://github.com/davidorex/cc-history-api/issues?q=is%3Aissue+label%3Agap) — Known limitation pending implementation
- [`refactor`](https://github.com/davidorex/cc-history-api/issues?q=is%3Aissue+label%3Arefactor) — Internal code restructuring (no behavior change)
- [`security`](https://github.com/davidorex/cc-history-api/issues?q=is%3Aissue+label%3Asecurity) — Security concern requiring hardening
